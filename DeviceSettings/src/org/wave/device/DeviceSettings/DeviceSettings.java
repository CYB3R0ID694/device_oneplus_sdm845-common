...
*
*/
package org.wave.device.DeviceSettings;
...
import org.wave.device.DeviceSettings.FileUtils;
import org.wave.device.DeviceSettings.doze.DozeSettingsActivity;
import org.wave.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.wave.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.wave.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.wave.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.wave.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
