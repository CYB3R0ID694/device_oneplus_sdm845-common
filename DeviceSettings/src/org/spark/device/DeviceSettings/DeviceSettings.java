...
import org.spark.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.spark.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.spark.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.spark.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.spark.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
