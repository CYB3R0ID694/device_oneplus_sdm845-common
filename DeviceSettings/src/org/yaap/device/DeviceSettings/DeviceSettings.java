...
*
*/
package org.yaap.device.DeviceSettings;
...
import org.yaap.device.DeviceSettings.FileUtils;
import org.yaap.device.DeviceSettings.doze.DozeSettingsActivity;
import org.yaap.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.yaap.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.yaap.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.yaap.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.yaap.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.yaap.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
