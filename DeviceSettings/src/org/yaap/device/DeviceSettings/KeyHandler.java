...
import org.yaap.device.DeviceSettings.Constants;
import org.yaap.device.DeviceSettings.DeviceSettings;
import org.yaap.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.yaap.device.DeviceSettings",
