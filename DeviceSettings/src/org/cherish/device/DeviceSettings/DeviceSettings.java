...
import org.cherish.device.DeviceSettings.FileUtils;
import org.cherish.device.DeviceSettings.doze.DozeSettingsActivity;
import org.cherish.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.cherish.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.cherish.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.cherish.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.cherish.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
