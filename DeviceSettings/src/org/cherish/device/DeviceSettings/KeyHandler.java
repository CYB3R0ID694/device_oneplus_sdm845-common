...
import org.cherish.device.DeviceSettings.Constants;
import org.cherish.device.DeviceSettings.DeviceSettings;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public static final String CLIENT_PACKAGE_PATH = "/data/misc/cherish/client_package_name";
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.cherish.device.DeviceSettings",
